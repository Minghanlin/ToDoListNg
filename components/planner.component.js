        ...
        execute: function() {
            PlannerComponent = (function () {
                function PlannerComponent() {
                    this.tasks = [
                        new task_component_1.Task("Cook an antelope", "Easy", false),
                        new task_component_1.Task("Learn coding from Gerald", "Peasy", false),
                        new task_component_1.Task("Ground coffee beans", "Tiring", false),
                        new task_component_1.Task("Eat a rainbow", "Impossible", false),
                        new task_component_1.Task("Pet an elephant", "Easy", false),
                        new task_component_1.Task("Wave at a panda", "Moderate", false),
                        new task_component_1.Task("Slurp a slurpee", "Boring", false)
                    ];
                }
